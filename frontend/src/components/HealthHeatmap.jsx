  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
        <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--text-45)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
          Endpoint Health History
        </span>
        <span style={{ fontSize: 10, color: 'var(--text-20)' }}>· last {COLS} readings (5s each)</span>
        <div style={{ marginLeft: 'auto', display: 'flex', gap: 10 }}>
          {[
            ...
            <div key={x.s} style={{ display: 'flex', alignItems: 'center', gap: 3, fontSize: 10, color: 'var(--text-30)' }}>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      background: status === null ? 'var(--text-03)' : STATUS_BG[status] || STATUS_BG.unknown,
      ...
      <div style={{ marginTop: 8, fontSize: 9, color: 'var(--text-15)', textAlign: 'right' }}>
        older {'←'} newer
      </div>
    </div>
  )
